...
public class Main {
    public static void main(String[] args){
        ...
        GerenciarArquivo arquivo_categorias = new GerenciarArquivo("src\\main\\java\\com\\uploads\\Categorias.csv",8);
        GerenciarArquivo arquivo_veiculos = new GerenciarArquivo("src\\main\\java\\com\\uploads\\Veiculos.csv",8);
